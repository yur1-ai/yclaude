    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-8 shadow-sm dark:border-[#30363d] dark:bg-[#161b22]">
        <p className="text-sm text-slate-600 dark:text-[#8b949e] mb-4">
          Conversation content is not displayed by default. To browse your Claude Code conversations,
          start the server with the <code className="text-xs bg-slate-100 dark:bg-[#21262d] px-1.5 py-0.5 rounded font-mono">--show-messages</code> flag.
        </p>
